...
public class PhotoUtil {
    ...
    public final static byte[] scale(String srcImageFile, int height, int width, boolean bb) {
        try {
            double ratio = 0.0; // 缩放比例
            File f = new File(srcImageFile);
            BufferedImage bi = ImageIO.read(f);
    ...
    public static void main(String[] args) throws IOException {
        String path="D:/student.jpg";    //输入图片  测试要在C盘放一张图片1.jpg
        PhotoUtil.scale("D://img//11.jpg","D:/yasuo.jpg", 160, 120, true);//等比例缩放  输出缩放图片

        /*File newfile=new File("D:/yasuo.jpg");
        ...
        if (width > 240) {
            ...
            bufferedimage=photoUtil.cropImage(bufferedimage,(int) ((width - 240) / 2),0,(int) (width - (width-240) / 2),(int) (height)
            );
            if (height > 320) {
                bufferedimage=photoUtil.cropImage(bufferedimage,0,(int) ((height - 320) / 2),240,(int) (height - (height - 320) / 2)
                );
            }
        }else{
            if (height > 320) {
                bufferedimage=photoUtil.cropImage(bufferedimage,0,(int) ((height - 320) / 2),(int) (width),(int) (height - (height - 320) / 2)
                );
            }
        }
        ImageIO.write(bufferedimage, "jpg", new File("D:/caijian.jpg"));    //输出裁剪图片*/
    }
}
